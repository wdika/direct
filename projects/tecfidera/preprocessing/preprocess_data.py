        ...
        for acquisition in acquisitions:
            ...
            for filename_kspace in kspaces:
                ...
                if name != '501':  # exclude the sense ref scan
                    ...
                    input_kspace = slice_selection(T.fftshift(ifftn(input_kspace, dim=0, norm="ortho"), dim=0), start=start, end=end)
                    ...
                    if not skip_csm:
                        ...
                        csm = slice_selection(complex_tensor_to_real_np(T.fftshift(torch.from_numpy(readcfl(filename_kspace.split('_')[0] + '_csm')), dim=0)), start=start, end=end)
