...
class DataTransform:
    ...
    def __call__(self, sample):
        ...
        masked_kspace = np.expand_dims(np.transpose(sample["kspace"], (1, 2, 0)), -2)
        sensitivity_map = np.expand_dims(np.transpose(np.fft.fftshift(sample["sensitivity_map"], axes=(1, 2)), (1, 2, 0)), -2)
